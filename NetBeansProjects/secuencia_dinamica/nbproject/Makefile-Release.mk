...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/secuencia_dinamica

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/secuencia_dinamica: ${OBJECTFILES}
...
${OBJECTDIR}/secuencia_dinamica.o: secuencia_dinamica.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/secuencia_dinamica.o secuencia_dinamica.c
...
${TESTDIR}/tests/prueba_secuencia_dinamica.o: tests/prueba_secuencia_dinamica.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/prueba_secuencia_dinamica.o tests/prueba_secuencia_dinamica.c
...
${OBJECTDIR}/secuencia_dinamica_nomain.o: ${OBJECTDIR}/secuencia_dinamica.o secuencia_dinamica.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/secuencia_dinamica_nomain.o secuencia_dinamica.c;\
	else  \
